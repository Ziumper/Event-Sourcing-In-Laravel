...
use DepositsForAccountsAndPeriod;
...
class AccountsController extends Controller
{
    public function index()
    {
        ...
        $deposits = new DepositsForAccountsAndPeriod(now()->format('Y-m-d'), now()->format('Y-m-d'))->getDeposits();
        
        return view('accounts.index', compact(['accounts','deposits']));
    }
